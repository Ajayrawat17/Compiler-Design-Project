...
{
  "\"end of file\"", "error", "\"invalid token\"", "INT", "RETURN", "ID",
  "NUM", "'('", "')'", "'{'", "'}'", "'='", "';'", "$accept", "program",
  "function", "body", YY_NULLPTR
};
...
{
       1,     4,     5,     7,     9,     6,    15,     0,     8,    11,
      12,    14,    16,    17,    13,     0,     0,     0,    18
};

static const yytype_int8 yycheck[] =
{
       3,     5,     0,     8,     3,     7,    12,    -1,     9,     5,
      10,     6,     4,     6,    11,    -1,    -1,    -1,    12
};
...
{
       0,     3,    14,    15,     5,     0,     7,     8,     9,     3,
      16,     5,    10,    11,     6,    12,     4,     6,    12
};
